  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute w-96 h-96 rounded-full bg-gradient-to-r from-indigo-100/20 to-purple-100/20 blur-3xl animate-parallax-float"
        />
        <div 
          className="absolute w-72 h-72 rounded-full bg-gradient-to-r from-emerald-100/15 to-cyan-100/15 blur-3xl animate-parallax-float [animation-delay:1s]"
        />
        <div className="absolute top-20 left-20 w-2 h-2 bg-indigo-400/60 rounded-full animate-gentle-pulse" />
        <div className="absolute top-40 right-32 w-3 h-3 bg-purple-400/60 rounded-full animate-gentle-pulse [animation-delay:1s]" />
        <div className="absolute bottom-32 left-40 w-2 h-2 bg-emerald-400/60 rounded-full animate-gentle-pulse [animation-delay:2s]" />
      </div>
